...
public class ObjectMatcherTests {
    ...
    public void compareNulls() {
        Map<String, Object> symbols = new ObjectMatcher().match(null, null, null, null);
        assertTrue(symbols.isEmpty());
    }

    @Test
    public void compareNullWithAssignSymbol() {
        Map<String, Object> symbols = new ObjectMatcher().match(null, "~[val]", null, null);
    ...
    public void compareNulls_negative() {
        ...
        String actual = null;
        new ObjectMatcher().match(null, expected, actual, null);
    }
    ...
    public void doNotMatchWithNull() {
        new ObjectMatcher().match(null, null, "val", new HashSet<>(Arrays.asList(MatchCondition.DO_NOT_MATCH)));
    }

    @Test(expected = AssertionError.class)
    public void doNotMatchWithNull_negative() {
        new ObjectMatcher().match(null, null, null, new HashSet<>(Arrays.asList(MatchCondition.DO_NOT_MATCH)));
    }

    @Test
    public void compareEmptyStrings() {
        new ObjectMatcher().match(null, "", "", null);
    }

    @Test
    public void doNotMatchEmptyStrings() {
        new ObjectMatcher().match(null, "", "val", new HashSet<>(Arrays.asList(MatchCondition.DO_NOT_MATCH)));
    }

    @Test(expected = AssertionError.class)
    public void doNotMatchEmptyStrings_negative() {
        new ObjectMatcher().match(null, "", "", new HashSet<>(Arrays.asList(MatchCondition.DO_NOT_MATCH)));
    }

    @Test
    public void comparePrimitives() {
        new ObjectMatcher().match("", 200, 200, new HashSet<>(Collections.singletonList(MatchCondition.JSON_NON_EXTENSIBLE_ARRAY)));
    }

    @Test
    public void comparePrimitivesOfDifferentTypes() {
        new ObjectMatcher().match("", 200L, 200, new HashSet<>(Collections.singletonList(MatchCondition.JSON_NON_EXTENSIBLE_ARRAY)));
    }

    @Test(expected = AssertionError.class)
    public void comparePrimitives_negative() {
        new ObjectMatcher().match("", 200.0, 200, new HashSet<>(Collections.singletonList(MatchCondition.JSON_NON_EXTENSIBLE_ARRAY)));
    }
    ...
    public void compareJsonWithAssignSymbols() {
        ...
        Map<String, Object> symbols = new ObjectMatcher().match(null, expected, actual, null);
    ...
    public void compareJsonNonExtensibleArrayWithAssignSymbolsOnFieldsAndValues() {
        String expected = "[{\"~[sym1]\":\"~[sym2]\"},{\"x\":false}]";
        String actual = "[{\"c\":0},{\"x\":false}]";
        Map<String, Object> symbols = new ObjectMatcher().match(null, expected, actual, new HashSet<>(Arrays.asList(MatchCondition.JSON_NON_EXTENSIBLE_ARRAY)));
        assertEquals("c", symbols.get("sym1"));
        assertEquals("0", symbols.get("sym2"));
        assertEquals(2, symbols.size());
    }
    ...
    public void doNotMatchJsonNonExtensibleArrayWithAssignSymbolsOnFieldsAndValues_negative() {
        String expected = "[{\"~[sym1]\":\"~[sym2]\"},{\"x\":false}]";
        String actual = "[{\"c\":0},{\"x\":false}]";
        Map<String, Object> symbols = new ObjectMatcher().match(null, expected, actual,
    ...
    public void doNotMatchXmlWithAssignSymbols_negative() {
        ...
        String actual = "<struct><boolean a=\"boolAttrValue\">false</boolean>"
                + "<int a=\"(attrValue1\">some text here</int><str a=\"some result\"><a>sub text</a></str></struct>";
        new ObjectMatcher().match(null, expected, actual,
                new HashSet<>(Arrays.asList(MatchCondition.DO_NOT_MATCH)));
    }
    ...
    public void doNotMatchXmlWithAssignSymbolsWithChildNodeSequence() {
        ...
        String actual = "<struct>"
                + "<boolean a=\"boolAttrValue\">false</boolean><int a=\"(attrValue1\">some text here</int><str a=\"some result\"><a>sub text</a></str></struct>";
        Map<String, Object> props = new ObjectMatcher().match(null, expected, actual,
